...
from utils import connect_wifi, init_display, disconnect_wifi
...
hour_label.anchored_position = (display.width-1, -8)
...
minute_label.anchored_position = (display.width-1, 47)
...
date_label.anchored_position = (display.width-10, 110)
date_label.text = "{:0>2d}/{:0>2d}".format(time_now.tm_mday,time_now.tm_hour)
